(function($) {
    ...
    function resetCursor() {
        ...
        cursor.classList.remove('cursor-lg');
        cursor.classList.remove('cursor-md');
    ...
    function peCursorInteraction(target) {
        ...
        target.addEventListener('mouseenter', ()=>{
            if (!target.classList.contains('cursor--disabled')) {
                ...
                if (type === 'text-md') {
                    cursor.classList.add('cursor--text');
                    cursor.classList.add('cursor-md');
                    cursorText.innerHTML = text;
                }

                if (type === 'text-lg') {
                    cursor.classList.add('cursor--text');
                    cursor.classList.add('cursor-lg');
                    cursorText.innerHTML = text;
                }
                if (type === 'icon') {
    ...
    window.addEventListener('elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/global', function($scope, $) {
            ...
            for (var i = 0; i < jsScopeArray.length; i++) {
                ...
                if (scope.classList.contains('grower--carousel')) {
            ...
            for (var i = 0; i < jsScopeArray.length; i++) {
                ...
                if (scope) {
                    ...
                    circularText.forEach(function($this) {
                        ...
                        let whaler = Hamster(document.querySelector('body')), wheelDeltaY, currentDeltaY;
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/pelayoutswitcher.default', function($scope, $) {
            ...
            for (var i = 0; i < jsScopeArray.length; i++) {
                ...
                let mainColors = [getComputedStyle(document.documentElement).getPropertyValue('--mainColor'), getComputedStyle(document.documentElement).getPropertyValue('--mainBackground'), getComputedStyle(document.documentElement).getPropertyValue('--secondaryColor'), getComputedStyle(document.documentElement).getPropertyValue('--secondaryBackground'), ]
                let switchedColors = [getComputedStyle(document.querySelector('.layout--colors')).getPropertyValue('--mainColor'), getComputedStyle(document.querySelector('.layout--colors')).getPropertyValue('--mainBackground'), getComputedStyle(document.querySelector('.layout--colors')).getPropertyValue('--secondaryColor'), getComputedStyle(document.querySelector('.layout--colors')).getPropertyValue('--secondaryBackground'), ]
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/peshowcaserotate.default', function($scope, $) {
            ...
            for (var i = 0; i < jsScopeArray.length; i++) {
                ...
                showcaseRotate.forEach(function($this) {
                    ...
                    var wheeler = Hamster(document.querySelector('.leksa-showcase-rotate')), rotation = 0, direction;
                    matchMedia.add({
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/pefullscreenlist.default', function($scope, $) {
            ...
            for (var i = 0; i < jsScopeArray.length; i++) {
                ...
                fsList.forEach(function(list) {
                    let speed = parseInt(list.dataset.speed), title = list.querySelectorAll('.project-title'), length = title.length, mainWrap = list.querySelector('.lfs-main-wrap'), cloneLength;
