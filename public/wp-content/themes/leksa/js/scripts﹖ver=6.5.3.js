(function($) {
    ...
    function leksaHeader() {
        ...
        setTimeout(function() {
            ...
            barba.hooks.after(()=>{
                setTimeout(()=>{
                    let scrolltriggers = ScrollTrigger.getAll(), newStart;
                    scrolltriggers.forEach(function(st) {
                        if ((st.pin != null) && (st.start <= window.innerHeight)) {
                            newStart = st.end;
                        }
    ...
    if (document.querySelector('.page--transitions')) {
        ...
        barba.hooks.enter((data)=>{
            ...
            const elementorTags = ['link[id*="elementor"]', 'link[id*="eael"]', 'style[id*="elementor"]', 'style[id*="eael"]', 'style[id*="elementor-frontend-inline"]', 'style[id*="elementor-post"]', 'link[id*="elementor-post"]', ].join(',');
            const headTags = ['meta[name="keywords"]', 'meta[name="description"]', 'meta[property^="og"]', 'meta[name^="twitter"]', 'meta[itemprop]', 'link[itemprop]', 'link[rel="prev"]', 'link[rel="next"]', 'link[rel="canonical"]', 'link[rel="alternate"]', 'link[rel="shortlink"]', 'link[id*="google-fonts"]', 'style[id*="leksa_-body-styles"]'].join(',');
            ...
            const existsInCurrentDOM = (newElement)=>{
                return Array.from(currentElements).some(currentElement=>currentElement.tagName.toLowerCase() === newElement.tagName.toLowerCase() && currentElement.id === newElement.id);
            }
            ;
